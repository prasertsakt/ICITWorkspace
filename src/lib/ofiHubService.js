...
export async function importOfiFromAudits(fiscalYear, audits, actor) {
  ...
  for (const audit of ofiAudits) {
    ...
    const ofiItem = {
      ...
      sourceItem: audit.item || '',
      sourceExpectedEvidence: audit.expectedEvidence || '',
      sourceFindings: audit.findings || '',
      sourceRecommendation: audit.recommendation || '',
      sourceStandard: audit.isoStandard || audit.standard || 'IMS 9001/27001',
      sourceAuditDate: audit.auditDate || '',
      sourceAuditors: audit.auditors || [],
      sourceAuditorName: audit.auditor1Name || '',
      sourceAuditees: audit.auditees || [],
      sourceAuditeeName: audit.auditee1Name || '',
      implement: '',
      status: '',
      remark: '',
      departments: [],
